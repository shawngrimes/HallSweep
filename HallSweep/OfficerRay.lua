...
MyCharacter=movieMachine.newAnim( { "images/officerray-1-iPad.png",
...
MyCharacter.myName="OfficerRay"
physics.addBody( MyCharacter, physicsData:get("officerray-2-iPad") )

MyCharacter.isFixedRotation = true

--Set your character's speed
MyCharacter.speed=5  -- Try changing this number to adjust the speed
