...
consumer_key = "XKxHKlGeZnaaiam8dPAw6A"			-- key string goes here
consumer_secret = "forUokNO68sXFwbmg5IYVABjXZERa9W99iuheKSvwk"		-- secret string goes here
...
--
webURL = "http://www.campfireapps.com"
...
-----------------------------------------------------------------------------------------
--
local function tweet_listener(event)
...
function tweet(del, msg)
	...
	if not settings.game.twitter.access_token then
		...
		print("Showing web popup: ".."http://api.twitter.com/oauth/authorize?oauth_token="
			.. twitter_request_token);
		webView = native.newWebView( 0, 0, Utils.screenWidth, Utils.screenHeight )

		webView:request("http://api.twitter.com/oauth/authorize?oauth_token=" .. twitter_request_token)
		webView:addEventListener( "urlRequest", tweet_listener )
